 ...
 */
public class ScwHeaderAugmenter {

    private static final String PAYLOAD_PREFIX = "payload.";

    private static final String HEADER_PREFIX = "header.";

    private static final Log logger = LogFactory.getLog(ScwHeaderAugmenter.class);
    ...
    public ScwHeaderAugmenter(Map<String, String> outputHeaders, AvroMessageReader avroMessageReader) {
