...
Follow the [User Defined Function](./user-defined-functions) documentation to learn how to implement and build Functions, and how to use them from within a Processor resource.
